...
from mrcnn.coord import CoordinateChannel2D
...
def identity_block(input_tensor, kernel_size, filters, stage, block,
    ...
    #x = CoordinateChannel2D()(input_tensor)
...
def resnet_graph(input_image, architecture, stage5=False, train_bn=True):
    ...
    x = CoordinateChannel2D()(input_image)
...
def rpn_graph(feature_map, anchors_per_location, anchor_stride):
    ...
    #y =CoordinateChannel2D()(feature_map)
...
class MaskRCNN():
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            keras.callbacks.ReduceLROnPlateau(monitor='loss',min_delta=0.01, 
                                        factor=0.3, patience=4, verbose=1, mode='min', cooldown=1, min_lr=0),
        ]
    ...
    def unmold_detections(self, detections, mrcnn_mask, mrcnn_mask_iou, original_image_shape,
        ...
        for i in range(N):
            ...
            full_mask = utils.unmold_mask(masks[i], boxes[i], original_image_shape, threshold=0.5) # threshold = -1 or 0..1, -1 means no use.
